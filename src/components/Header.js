            ...
            <div className={"headerTop"} style={{
                ...
                <div className={"side"}>
                    ...
                    <div onClick={() => setLink('contact')} className={"linkDiv"}>
                        <a className={"link"} href={"#contact"} style={{color: link === 'contact' && '#FEB633'}}>Contact</a>
