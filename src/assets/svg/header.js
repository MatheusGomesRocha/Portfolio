export default (props) => {
    return(
        <svg id="6088ba52-b752-42bb-ac91-0a74df332082" width={props.mobile ? '300px' : '500px'} height={props.mobile ? '300px' : '500px'} viewBox="0 0 900.94 787">
            <defs>
            ...
            <rect x="37.63" y="315" width="52" height="27" fill="#2f2e41" opacity="0.2"/>
            <rect x="318.63" width="52" height="27" fill="#2f2e41" opacity="0.2"/>
            <rect x="728.63" y="498" width="52" height="27" fill="#2f2e41" opacity="0.2"/>
            <rect x="41.63" y="348" width="52" height="27" fill="#2f2e41" opacity="0.2"/>
            <rect x="355.63" y="31" width="52" height="27" fill="#2f2e41" opacity="0.2"/>
            <rect x="165.63" y="214" width="52" height="27" fill="#2f2e41" opacity="0.2"/>
            <rect x="202.63" y="245" width="52" height="27" fill="#2f2e41" opacity="0.2"/>
            <rect x="301.63" y="228" width="52" height="27" fill="#2f2e41" opacity="0.2"/>
            <rect x="206.63" y="278" width="52" height="27" fill="#2f2e41" opacity="0.2"/>
            <rect x="798.63" y="498" width="52" height="27" fill="#2f2e41" opacity="0.2"/>
            <path
